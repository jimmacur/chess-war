  ...
  data() {
    return {
      ...
      avatars: [
        ...
        { src: "/src/assets/avatars/queenbee.png", name: "Queen Bee" },
        { src: "/src/assets/avatars/knightrider.png", name: "Knight Rider" },
        { src: "/src/assets/avatars/techknight.png", name: "Tech Knight" },
        { src: "/src/assets/avatars/knightmare.png", name: "Knightmare" },
